...
var SelectPrimary = function SelectPrimary(_ref) {
  var classesProp = _ref.classes,
      value = _ref.value,
      otherProps = _objectWithoutProperties(_ref, ["classes", "value"]);

  var classes = (0, _styles["default"])();
  return /*#__PURE__*/React.createElement(_Select["default"], _extends({
    classes: (0, _mergeClasses["default"])({
      icon: classes.selectIcon,
      root: (0, _clsx["default"])(classes.selectRoot, (0, _isNil["default"])(value) && classes.selectRootEmpty),
      select: classes.selectComponentRoot
    }, classesProp),
    defaultValue: "0",
    disableUnderline: true,
    IconComponent: _ChevronDown["default"],
    margin: "dense",
    value: value
  }, otherProps));
};

var _default = SelectPrimary;
