...
var EmptyState = function EmptyState(_ref) {
  var action = _ref.action,
      ...
      flexibleHeight = _ref.flexibleHeight,
      Icon = _ref.Icon,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_style["default"], {
    ...
    alignItems: "center",
    classes: {
      container: "".concat(classes.titleGridContainer, " ").concat(description ? classes.titleGridContainerWithDescription : '')
    },
    container: true,
    justify: "center"
    ...
    align: "center",
    classes: {
      root: (0, _clsx["default"])(classes.descriptionRoot, flexibleHeight && classes.descriptionRootFlexibleHeight, !title && classes.descriptionRootWithoutTitle)
    },
    style: {
      maxWidth: maxWidth
    },
    variant: "body1"
  }, description), action && /*#__PURE__*/React.createElement(_ActionButton["default"], action)));
};
