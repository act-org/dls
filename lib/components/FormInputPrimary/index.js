...
var FormInputPrimary = function FormInputPrimary(_ref) {
  ...
  var children = /*#__PURE__*/React.createElement("div", {
    ...
    fullWidth: true,
    required: required
  }, inputProps)), (0, _get["default"])(inputProps, 'error') && /*#__PURE__*/React.createElement(_AlertOutline["default"], {
    classes: {
  ...
  }, [".labelContainer.__jsx-style-dynamic-selector{margin-bottom:".concat(_dims["default"].LAYOUT_PADDING / 2, "px;}"), ".inputContainer.__jsx-style-dynamic-selector{position:relative;}"]), labelProps && /*#__PURE__*/React.createElement("div", {
    className: _style["default"].dynamic([["1665125644", [_dims["default"].LAYOUT_PADDING / 2]]]) + " " + "labelContainer"
